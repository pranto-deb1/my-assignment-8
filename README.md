...
-  **React Router v7** – রাউটিং ও পেজ নেভিগেশন  
-  **Tailwind CSS 4** – স্টাইলিং ও রেস্পনসিভ ডিজাইন  
-  **@tailwindcss/vite** – Tailwind এর জন্য Vite ইন্টিগ্রেশন  
-  **React Icons 5** – সুন্দর ও হালকা আইকন  
-  **React Toastify 11** – Toast notification  
