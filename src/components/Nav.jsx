...
const Nav = () => {
    ...
    return (
        <div className='h-[155px] md:h-[78px] pl-[20px] md:pl-[0px] bg-white flex gap-[10px] flex-wrap justify-start md:justify-around items-center'>
            ...
            <button className="w-[145px] h-[43px] text-white rounded-md bg-[linear-gradient(125.07deg,rgba(99,46,227,1),rgba(159,98,242,1)_100%)] flex justify-center items-center gap-[10px]"><FaGithub />Contribute</button>
        </div>
